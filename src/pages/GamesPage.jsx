...
const GamesPage = () => {
  ...
  const searchQuery = { searchSort, searchPlatform, searchGenre, page };
  React.useEffect(() => {
  ...
  }, [activeSort, activePlatform, activeGenre, page]);
            ...
            <div className="pagination">
              {page > 1 ? (
                <div
                  ...
                  className="pagination-left pagination-btn"
                >
                  PREVIOUS PAGE
                </div>
              ) : (
              ...
              <div
                ...
                className="pagination-right pagination-btn"
              >
                NEXT PAGE
              </div>
            </div>
